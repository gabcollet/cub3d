...
/*   Updated: 2022/01/30 19:22:10 by sfournie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	door_set_visible(t_door *door, double rot)
{
	int			view;
...
void	doors_set_visible(t_door *doors, int size, double rot, t_pos pos)
{
	int			i;
	t_door		*door;
	t_pos		side_pos;
